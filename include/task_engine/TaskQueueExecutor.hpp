...
using TaskQueueFunc = std::function<void(
    ...
    const CancelController::Checker& isCancelled)>;
...
struct TaskQueueExecutorStartParam
{
    int taskType;
    boost::any threadLocalData;
    CancelController::Checker isCancelled;
};
...
{
public:
    explicit TaskQueueExecutor(const CancelController::Checker& cancelParam) :
...
private:
    CancelController::Checker m_cancelParam;
